...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // String MDInputPath = "xxx.md";
        // String outputPath = "xxx-out.html";
        // String mdText = FileTool.readFile(MDInputPath);
        // mdText = LatexTool.convertLatex(mdText, false, new
        // File(MDInputPath).getParent());
        // String html = MDTool.md2htmlWithText(mdText, null, null, true);
        // FileTool.writeFile(outputPath, html);
    }
